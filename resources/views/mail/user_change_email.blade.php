        ...
        if ($time_now < 11 && $time_now>= 01) {
            $notification = 'Selamat Pagi';
                ...
                $notification = 'Selamat Siang';
                    ...
                    @endphp
                    <div class='container'>
                        <h2>Pemberitahuan Perubahan Alamat Email</h2>
                        <p>{{$notification}} <b> {{$user->name}}</b></p>
                        <p>Catatan kami menunjukkan bahwa Anda baru saja mengubah alamat email yang terhubung ke akun
                            mitra
                            Point Trash Anda ({{$user->email}}).
                        </p>
                        <br><br>
                        <center>
                            <p>Untuk informasi lebih lanjut silahkan hubungi CS kami, <a href='{{env('
                                    APP_URL')}}/contact'>klik
                                    disini</a>.</p>
