    ...
    function buildTableRows(data, page, per_page) {
            ...
            data.forEach((item, index) => {
                ...
                html += `<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                    ...
                    <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400 border dark:border-slate-700">
                        <a href="javascript:void(0)" data-fc-type="modal" data-id="${item.account_id}" data-fc-target="_modal_saldo" class="_add_saldo text-primary-500 hover:text-primary-700"><i class="fas fa-plus fa-1x"></i>Saldo</a>
                        <a href="javascript:void(0)" data-fc-type="modal" data-id="${item.account_id}" data-fc-target="_modal_form" class="_edit_modal text-primary-500 hover:text-primary-700"><i class="fas fa-edit fa-1x"></i> Edit</a>
                        <button class="text-red-500 hover:text-danger-700 _delete" data-id="${item.account_id}"><i class="fas fa-trash fa-1x"></i> Hapus</button>
                    </td>
                </tr>`;
            });
        ...
        function getData(page = 1) {
            ...
            fetchData(url, page, per_page, search, "get", function (data) {
                ...
                $('._edit_modal').on('click', function () {
                    ...
                    const itemData = itemDataArray.find(item => item.account_id === itemId);
                    // each data from array
