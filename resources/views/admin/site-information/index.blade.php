    ...
    <div
        ...
        <div class="flex-auto p-4 ">
            <form action="{{ route('information.update', [$information->information_id]) }}" method="POST">
                ...
                @csrf
                <div class="mb-2">
                    <label for="site_name" class="font-medium text-sm text-slate-600 dark:text-slate-400">Nama
                        Situs</label>
                    <input type="text" id="site_name" name="site_name"
                        class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700"
                        placeholder="name@t-wind.com" value="{{ $information->site_name }}" required="">
                </div>
                <div class="mb-2">
                    <label for="site_title" class="font-medium text-sm text-slate-600 dark:text-slate-400">Judul
                        Situs</label>
                    <input type="text" id="site_title" value="{{ $information->site_title }}" name="site_title"
                        class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700"
                        required="">
                </div>
                <div class="mb-2">
                    <label for="Mobile_Number"
                        class="font-medium text-sm text-slate-600 dark:text-slate-400">Copyrights</label>
                    <input type="text" id="Copyrights" name="copyrights" value="{{ $information->copyrights }}"
                        class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700"
                        required="">
                </div>
