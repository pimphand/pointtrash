            ...
            <div class="relative w-auto pointer-events-none  sm:my-7 sm:mx-auto z-[99] lg:max-w-4xl">
                <div
                    ...
                    <div
                        ...
                        <h6 class="mb-0 leading-4 text-base font-semibold text-slate-300 mt-0" id="_title_modal">Edit
                            Share Profit {{str_replace('_',' ',Str::title($status))}}</h6>
                        <button type="button"
        ...
        $('#_table-data').on('click', '._delete', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const url = "{{ route('orders.destroy',':id') }}" // URL untuk menghapus data
                        .replace(':id', itemId);
