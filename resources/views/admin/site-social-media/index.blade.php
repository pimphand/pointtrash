...
<div class="sm:col-span-12  md:col-span-12 lg:col-span-8 xl:col-span-6 xl:col-start-4 ">
    <div
        ...
        <div class="flex-auto p-4 ">
            <form action="{{ route('social-media.update', [$socialMedia->socmed_id]) }}" method="POST">
                @method('put')
                @csrf
                @foreach ($socialMedia->attributesToArray() as $key=> $item)
                @if ($key != 'socmed_id' || $key == 'created_at' || $key == 'updated_at')
                <div class="mb-2">
